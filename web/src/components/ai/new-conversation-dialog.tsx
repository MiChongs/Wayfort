  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl p-0 gap-0 overflow-hidden">
        ...
        <div className="max-h-[60vh] overflow-y-auto px-5 pb-5 space-y-4">
          {agents.isLoading && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {items.map((a, i) => (
                      <AgentCard
                        ...
                        agent={a}
                        index={i}
                        loading={create.isPending && create.variables === a.id}
...
function AgentCard({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "text-left rounded-lg border bg-card hover:border-primary/40 hover:shadow-md transition-all",
